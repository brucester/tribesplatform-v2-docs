// Regenerative Neighborhood Wizard — TypeScript port of window.FW_DATA
...
export const PILLAR_STEPS: Record<string, { id: string; title: string; note: string }[]> = {
  ecology: [
      ...
      steps: [
        {
          ...
          fields: [
            { id: 'where_now', label: 'Where are you on your community journey?', kind: 'textarea',
              ...
              guide: { title: 'Where you are now', source: 'Alchemy §1.1',
                body: ['Examine where you are now to understand your community vision. What\'s your current life, work, and relationships like? What do you have access to (skills, capital, land, network)? What\'s missing?',
            ...
            { id: 'dream_origin', label: 'Dream origin — what brought you to this idea?', kind: 'textarea',
              ...
              guide: { title: 'Your dream origin', source: 'Alchemy §1.2',
                body: ['What brought you to the idea of making this community? How did you find this path?',
            ...
            { id: 'why_personal', label: 'Why does this matter to YOU personally?', kind: 'textarea',
              ...
              guide: { title: 'Personal why', source: 'CLIPS · Individual',
                body: ['A regenerative neighborhood will test your personal stamina, finances, relationships, and health. CLIPS calls the Individual the innermost ring — neglecting it cracks the whole structure later.',
            ...
            { id: 'why_world', label: 'What problem in the world does this address?', kind: 'textarea',
              ...
              guide: { title: 'The problem you\'re solving', source: 'Alchemy §1.2 + Regenaissance',
                body: ['Diana Leafe Christian writes that "a community\'s ideals usually arise from something that its members see as lacking or missing from the wider culture." Name what is missing.',
            ...
            { id: 'why_now', label: 'Why now? Why this place?', kind: 'textarea',
              ...
              guide: { title: 'Why now, why here', source: 'Alchemy §1',
                body: ['Communities that succeed usually have a specific window: a piece of land coming available, a generation of founders ready, a regulatory opening, a cultural moment. Name yours.',
            ...
            { id: 'values', label: 'Your ethos: 3–5 core values', kind: 'textarea',
              ...
              guide: { title: 'Values vs. aspirations', source: 'Alchemy §1.3',
                body: ['List values you want to uphold. Diana Leafe Christian: a community\'s ideals usually arise from something members see as lacking in the wider culture.',
...

        {
          ...
          fields: [
            { id: 'team_members', label: 'Founding members (name · role · commitment)', kind: 'textarea', rows: 6,
              ...
              guide: { title: 'Sizing the founding group', source: 'Alchemy §2 · Together Resilient · Creating a Life Together',
                body: ['The recommended founding group is 7–12 people: small enough for agility, large enough for diverse skills and perspectives. A single family is the start of an idea, not yet a community.',
                  ...
                  'Co-founder vs. member vs. participant: a co-founder shares your high-level goals AND has skill + capacity to take on flexible roles. A member is aligned and contributing but not driving.'] } },
            { id: 'ideal_archetypes', label: 'Ideal community member archetypes', kind: 'textarea',
              ...
              guide: { title: 'Ideal members', source: 'Alchemy §2 — Ideal Community Members',
                body: ['Define the archetypes of the people you most want to share community life with. Think roles, life stage, skills, dispositions — not demographic checkboxes.',
            ...
            { id: 'skills_have', label: 'Skills you have on the team', kind: 'textarea',
              ...
              guide: { title: 'Skill inventory', source: 'Alchemy §2.4 — Essential Roles',
                body: ['Common roles: Planning & Design Visionary, Accountant/Legal, Marketing Storyteller, Business Planner, Masterplanner/Architect, Recruitment, Permaculturalist/Food System Designer, Water Filtration, Electrician/Network.',
            ...
            { id: 'skills_gap', label: 'Critical skills you\'re missing', kind: 'textarea',
              ...
              guide: { title: 'Naming the gap', source: 'Alchemy §2.4',
                body: ['List the roles where you have no internal coverage. For each, decide: recruit a co-founder, hire a contractor, or accept the gap until later.',
            ...
            { id: 'value_exchange', label: 'Value exchange: what each member type gives & gets', kind: 'textarea', rows: 5,
              ...
              guide: { title: 'The harmony principle', source: 'Alchemy §2.5 — Value Exchange',
                body: ['For each archetype, name what they give (capital, time, skills, presence) and what they get (ownership, equity, profit, special benefits, access, experience, ROI, education).',
            ...
            { id: 'stakeholders_external', label: 'External stakeholders (non-member)', kind: 'textarea',
              ...
              guide: { title: 'Wider stakeholder lens', source: 'Alchemy §2.2 — Stakeholders',
                body: ['Internal stakeholders are founders, members, investors. External stakeholders include: ecosystem & geological features, local communities, government bodies, outside visitors, downstream consumers of what you create.',
...

        {
          ...
          fields: [
            { id: 'project_name', label: 'Working name for your neighborhood', kind: 'input',
              ...
              guide: { title: 'Naming', source: 'Alchemy §1 — Name',
                body: ['Choose a name that reflects your values, ideals, and overall vibe. You\'ll revisit it during marketing/branding — but having an initial name is crucial for talking about the project clearly.',
            ...
            { id: 'purpose', label: 'PURPOSE — your BIG why (2–3 sentences)', kind: 'textarea',
              ...
              guide: { title: 'Purpose / Big Why', source: 'Workbook §1 · Alchemy §1.2',
                body: ['Look at your dream origin. From that story, examine why you want to create a regenerative neighborhood. This can be considered the problem statement you seek to solve.',
                  'Common purposes: co-work for digital nomads · entrepreneurship · wellness & holistic lifestyle · permaculture · art · human connection · spiritual development · technology · education · environment-wildlife · longevity.'] } },
            { id: 'mission_statement', label: 'MISSION — how you will accomplish the why (1–4 sentences)', kind: 'textarea',
              ...
              guide: { title: 'Mission statement', source: 'Alchemy §1.2 — Mission',
                body: ['A 1–4 sentence statement that summarizes what will happen when your community is working together and accomplishing its goals. It guides core team decisions, preserving essence over time.',
                  'Examples: · Cosmic Sol — "growing food using regenerative and self-sufficient methods... a sanctuary for healing and self-expression." · Meadowdance — "an egalitarian, child-centered community that welcomes human diversity, ecological sensibility, mutual learning, and joy."'] } },
            { id: 'vision_statement', label: 'VISION — what exists when everything works (1, 3, 5, 10, 20, 50 yr)', kind: 'textarea', rows: 6,
              ...
              guide: { title: 'Vision — the mental walk-through', source: 'Alchemy §1.3 — Vision',
                body: ['Picture your project at peak success. Mentally walk through the community and describe specifically what you see.',
            ...
            { id: 'goals_3yr', label: 'Initial goals (1–3 years)', kind: 'textarea',
              ...
              guide: { title: '1–3 year goals', source: 'Alchemy §1.4',
                body: ['Focus on the achievements most important to your community values. For each goal, state the goal and why it matters.'] } },
            { id: 'goals_5_10yr', label: 'Mid- and long-term goals (5 / 10 years)', kind: 'textarea',
              help: 'Overall community goals and intended impact.',
              guide: { title: '5–10 year goals', source: 'Alchemy §1.5–1.6',
                body: ['Shift attention to the goals you would like the community to achieve over 5 and 10 years. Think of overall community goals and the main impact you wish to have on residents, surrounding ecosystem, and the wider movement.'] } },
            { id: 'community_type', label: 'Community type(s)', kind: 'textarea',
              help: 'Pick one or more — what your community essentially is.',
              guide: { title: 'Community type', source: 'Alchemy §1 — Community Type',
                body: ['Common types: Residential or Family-Focused · Digital Nomad · Farm/Permaculture Center · Wellness/Retreat · Spiritual · Artist/Maker\'s Collective · Innovation & Alternative Education · Homesteading/Traditional Living · Plant Medicine · Indigenous/Ethnicity-Based · Lifestyle · Conservation Project · Caravan/Temporary Community.',
            ...
            { id: 'community_size', label: 'Community size range', kind: 'input',
              ...
              guide: { title: 'Sizing the community', source: 'Alchemy §2.1 — Size',
                body: ['Lower limit: 3 households / 7–12 people. A single family is the start of an idea, not yet a community.',
            ...
            { id: 'counterpart_analysis', label: 'Existing counterpart analysis (similar projects you admire)', kind: 'textarea', rows: 5,
              ...
              guide: { title: 'Studying counterparts', source: 'Alchemy §1 — Existing Counterpart Analysis',
                body: ['List existing projects similar to what you want to create. For each, write: what you like about it, what you want to do differently.',
            ...
            { id: 'scope', label: 'Scope: what does this neighborhood govern?', kind: 'textarea',
              ...
              guide: { title: 'Scope (RCOS Layer 0)', source: 'RCOS Layer 0',
                body: ['Layer 0 of RCOS asks: what is this community actually FOR, and what is OUTSIDE its remit? Is it a residential community? Also a business? Also an education center?',
...

        {
          ...
          checklist: [
            { id: 'a_decision', text: 'Decision-making method documented (consensus, sociocracy, etc.)',
              guide: { title: 'Decision-making method', source: 'Alchemy §3 + RCOS Layer 2',
                body: ['Tick when you can name HOW your group reaches a binding decision: who proposes, who consents, who can block, what the fallback is.',
            ...
            { id: 'a_meeting', text: 'Regular meeting cadence established',
              guide: { title: 'Meeting cadence', source: 'Alchemy §2 — Mobilizing',
                body: ['Decide on a time, place, and frequency to meet. Some groups meet half in-person and call in others.',
                  'Format matters as much as cadence: alternate "being meetings" with "doing meetings."'] } },
            { id: 'a_membership', text: 'How members join and leave is written down',
              guide: { title: 'Membership lifecycle', source: 'Alchemy §2.6–2.10',
                body: ['Tick when you have written: how someone enters (informational session → application → trial → vote) AND how someone exits (warning system → review → community vote → exit interview).',
                  'Drafting offboarding BEFORE you accept anyone is the move experienced founders most wish they had made earlier.'] } },
            { id: 'a_money', text: 'How money is handled in this phase is agreed',
              guide: { title: 'Money handling', source: 'RCOS Layer 3',
                body: ['In Phase 1 your money question is small but consequential: who has signing authority, where do funds sit, who can approve expenses, how transparent are accounts?',
                  'A simple agreement now saves a painful renegotiation when capital scales up.'] } },
            ...
            { id: 'a_communication', text: 'Communication channels and norms defined',
              guide: { title: 'Communication norms', source: 'Workbook §11',
                body: ['Pick a primary internal channel (WhatsApp, Telegram, Discord, Slack, Tribes) and stick to it. Define what each channel is FOR.',
          ...
          fields: [
            { id: 'governance_model', label: 'Governance model', kind: 'input',
              ...
              guide: { title: 'Choosing a governance model', source: 'Alchemy §3 + RCOS Layer 2',
                body: ['Common models: Democracy (majority vote) · Sociocracy (consent-based, circles & double-linking) · Holacracy (role-based, formalized) · Meritocracy (decision rights tied to demonstrated capacity) · hybrids.',
                  'No model is "best" — the best model is one your team understands, will actually use, and matches your size and culture.'] } },
            { id: 'decision_method', label: 'Your decision-making method', kind: 'textarea',
              help: 'Name it. "We\'ll figure it out" is not an answer.',
              guide: { title: 'Decision-making', source: 'Alchemy §3',
                body: ['Document HOW decisions get made: who proposes, who consents, who can block, what the fallback is. Different decision types may use different processes (operational vs. mission-level).'] } },
            { id: 'conflict_process', label: 'How will you handle the first conflict?', kind: 'textarea',
              ...
              guide: { title: 'Conflict process', source: 'RCOS Layer 4 + Alchemy §3',
                body: ['A first-pass process: 1) direct conversation 2) facilitated conversation with a neutral third party 3) circle process with affected parties 4) restorative justice / community council. Write yours down before you need it.'] } },
            { id: 'community_agreements', label: 'Community agreements (rules · processes · principles)', kind: 'textarea', rows: 5,
              ...
              guide: { title: 'Community agreements', source: 'Alchemy §3.4',
                body: ['Agreements should include: Rules · Processes & Protocols · Social Relationships & Dynamics · Ecological, Economic, and Worldview Principles.',
                  'Rules: noise, pets, property maintenance, safety, legal compliance. Processes: how regularly-occurring things get done.'] } },
            { id: 'legal_structure', label: 'Legal structure for ownership', kind: 'textarea',
              help: 'How does the project own the land?',
              guide: { title: 'Legal structure', source: 'Workbook §3 · Alchemy §3',
                body: ['Common structures: each member owns a lot · each member is a shareholder of the top company · condominium association · land trust · cooperative · LLC + bylaws.',
            ...
            { id: 'communication_channels', label: 'Communication channels & norms', kind: 'textarea',
              ...
              guide: { title: 'Communication infrastructure', source: 'Workbook §11',
                body: ['Pick a primary internal messaging system and stick to it. Common picks: WhatsApp, Telegram, Discord, Slack, Tribes/ReVillager.',
            ...
            { id: 'ecological_philosophy', label: 'What overarching philosophy does your community share about coexisting with nature?', kind: 'textarea',
              ...
              guide: { title: 'Ecological philosophy', source: 'Alchemy §3 · Ecological Outlook',
                body: ['Your ecological stance filters who joins and how you design. Are you zero-waste? Plant-based? Focused on rewilding? Regenerative agriculture? Name it explicitly.',
            ...
            { id: 'land_resale_policy', label: 'What happens when a member wants to sell their share or lot?', kind: 'textarea',
              ...
              guide: { title: 'Land share resale', source: 'Alchemy §3 · Land Share Resale',
                body: ['Can members sell to anyone? Only to pre-approved members? With price caps? Does the community have first right of refusal? These rules shape membership continuity over decades.',
            ...
            { id: 'founder_exit_protocol', label: 'What happens if founders stop agreeing on the vision?', kind: 'textarea',
              ...
              guide: { title: 'Founder disagreement protocol', source: 'Alchemy §3 · Founder Disagreement',
                body: ['The founders who dream together may not want to build together. Plan succession, buyout terms, or mediation protocols before you need them.',
                  'Disagreement doesn\'t have to tank the project — but only if you\'ve pre-agreed on how to resolve it.'] } },
            { id: 'shared_lifestyle_stance', label: 'What shared lifestyle practices will your community hold?', kind: 'textarea',
      ...
      steps: [
        {
          ...
          fields: [
            { id: 'business_models', label: 'Business model(s) — how is the neighborhood financially sustainable?', kind: 'textarea',
              ...
              guide: { title: 'Business models', source: 'Workbook §4 + Alchemy §4',
                body: ['Common revenue streams: Hospitality (rentals, retreats) · Events / activations · Gastronomy / restaurant · Food production sales · Products (jewelry, creams, herbs) · Services (consulting, training, design).',
            ...
            { id: 'value_flows', label: 'How will value flow through your community?', kind: 'textarea',
              ...
              guide: { title: 'Value flows (RCOS Layer 3)', source: 'RCOS Layer 3',
                body: ['Layer 3 (Resources & Value) asks: what do members give, what do they get, and how is value mediated? Cash · time · skill · access · housing · food · status · ownership.',
            ...
            { id: 'revenue_streams', label: 'Revenue streams (year 1, 3, 5)', kind: 'textarea',
              ...
              guide: { title: 'Revenue evolution', source: 'Alchemy §4',
                body: ['Year 1 revenue is usually pre-sales, founder capital, friends-and-family. Year 3 starts to see hospitality + events + early product income. Year 5 is when most community businesses cross into operational sustainability.',
            ...
            { id: 'cost_structure', label: 'Major cost structure', kind: 'textarea',
              ...
              guide: { title: 'Cost structure', source: 'Workbook §6',
                body: ['Capital costs: Land · Legal & permitting · Land prep · Design · Infrastructure · Construction · Furniture & decor.',
            ...
            { id: 'resident_finances', label: 'Resident finances (dues, shared expenses, shared income)', kind: 'textarea',
              ...
              guide: { title: 'Resident financial model', source: 'Workbook §4',
                body: ['Common arrangements: monthly dues for shared expenses · pooled household labor · co-op-style shared income from community businesses · hybrid (base dues + opt-in pools).',
            ...
            { id: 'commons', label: 'Commons & shared resources', kind: 'textarea',
              ...
              guide: { title: 'Designing the commons', source: 'RCOS Layer 3 + Ostrom',
                body: ['Common: shared house · kitchen · co-working · garden · vehicles · tools · childcare · ceremony space · gym · body of water · school · art space · first-aid space · makerspace.',
            ...
            { id: 'real_estate_model', label: 'How do people buy in?', kind: 'textarea',
              ...
              guide: { title: 'Buy-in model', source: 'Workbook §4',
                body: ['Options: Individual purchase (own a lot) · Fractional ownership · Collective ownership (shares of company) · Membership (no ownership, title for use) · Hybrid.',
                  'Each option has different legal, tax, financing, and cultural implications.'] } },
            { id: 'economic_philosophy', label: 'What does your community believe in when it comes to economic systems?', kind: 'textarea',
              ...
              guide: { title: 'Economic belief system', source: 'Alchemy §3 · Economic Belief Systems',
                body: ['Your economic philosophy underlies every financial decision. Gift economy? Cooperative? Market-driven? Shared income? Circular? Name it explicitly.',
            ...
            { id: 'market_research', label: 'Have you validated that your business models have viable demand in your region?', kind: 'textarea',
              ...
              guide: { title: 'Market research', source: 'Alchemy §4 · Market Research',
                body: ['Don\'t assume. Retreats work near cities and airports. Agritourism needs highways. Workshops need target markets. Talk to at least 20 potential customers before building infrastructure.',
...

        {
          ...
          fields: [
            { id: 'location_setting', label: 'Density setting & landscape', kind: 'input',
              ...
              guide: { title: 'Setting & landscape', source: 'Workbook §5',
                body: ['Density: Urban · Suburban · Rural — drives zoning, neighbor relationships, and infrastructure cost.',
            ...
            { id: 'climate', label: 'Climate', kind: 'input',
              ...
              guide: { title: 'Climate', source: 'Alchemy §5',
            ...
            { id: 'site_criteria', label: 'Site selection criteria', kind: 'textarea',
              ...
              guide: { title: 'Site criteria checklist', source: 'Alchemy §5',
                body: ['Core dimensions to score every candidate site: water (year-round source) · soil quality · access (roads, airports, hospitals) · climate resilience · zoning compatibility · neighbors / political climate · price · proximity to allies and supply chains.',
            ...
            { id: 'sites_considered', label: 'Sites under consideration', kind: 'textarea', rows: 5,
              ...
              guide: { title: 'Sites under consideration', source: 'Alchemy §5',
            ...
            { id: 'eco_assessment', label: 'Ecological assessment notes', kind: 'textarea',
              ...
              guide: { title: 'Ecological assessment', source: 'Alchemy §5 + Permaculture site analysis',
                body: ['Walk the land in different seasons if possible. Note: water flow patterns · soil tests · existing flora/fauna · degraded zones · natural assets · solar exposure · prevailing winds · slope/aspect.',
            ...
            { id: 'land_size', label: 'Land size (acres or hectares)', kind: 'input',
              ...
              guide: { title: 'Sizing the land', source: 'Workbook §0',
                body: ['A useful frame: 1 acre per person for full food/water/shelter self-sufficiency in a temperate climate. Most village-scale projects start at 20–200 acres.'] } },
            { id: 'zoning', label: 'Regulatory / zoning status', kind: 'input',
              help: 'Residential · Commercial mixed · Agricultural · SEZ · Industrial · Other.',
              guide: { title: 'Zoning & regulation', source: 'Workbook §5',
            ...
            { id: 'climate_emergencies', label: 'What climate emergencies is your site susceptible to, and how will you mitigate?', kind: 'textarea',
              ...
              guide: { title: 'Climate resilience', source: 'Alchemy §3 · Climate Resilience',
                body: ['Don\'t just know the risk — bake mitigation into your master plan. Firebreaks, swales, drought-tolerant planting, stormwater management, elevated structures.',
            ...
            { id: 'cultural_land_context', label: 'What is the cultural context of where you intend to build? How will you avoid neocolonialism?', kind: 'textarea',
              ...
              guide: { title: 'Cultural context & neocolonialism', source: 'Alchemy §3 · Cultural Context',
                body: ['If you\'re building on Indigenous or colonized land, acknowledge it. Learn the history. Compensate, consult, and co-create with locals rather than imposing a vision.',
                  'Regenerative neighborhoods that ignore local context often face resistance, permit denial, or social conflict that derails the project.'] } },
          ],
          sliders: [
...

        {
          ...
          fields: [
            { id: 'funding_need_total', label: 'Total capital need (rough estimate)', kind: 'input',
              ...
              guide: { title: 'Sizing the capital ask', source: 'Workbook §6',
                body: ['Build the number from: Land + Legal/permitting + Land prep + Design + Infrastructure + Team/staff (24mo) + Marketing + Furniture/decor.',
                  'Add a 20–30% contingency. Most regenerative neighborhoods underestimate by ~25%.'] } },
            { id: 'funding_breakdown', label: 'Capital need breakdown', kind: 'textarea', rows: 5,
              ...
              guide: { title: 'Breakdown', source: 'Workbook §6',
            ...
            { id: 'funding_sources', label: 'Funding sources you\'re pursuing', kind: 'textarea',
              ...
              guide: { title: 'Funding sources', source: 'Workbook §6 + Alchemy §6',
                body: ['Common sources: Self-invested · Bank loans · Friends & family · Business revenue · Resident revenue · Patrons · Mission-aligned investors · Pre-sales of memberships or units · Grants · Land trusts.',
                  'A healthy capital stack mixes patient capital (land trust, equity) with working capital (revenue, presales).'] } },
            { id: 'funding_timeline', label: 'Capital formation timeline', kind: 'textarea',
              help: 'When does each tranche need to close?',
              guide: { title: 'Capital timeline', source: 'Alchemy §6',
            ...
            { id: 'values_aligned_capital', label: 'How do you ensure capital sources are aligned with your mission, not just available?', kind: 'textarea',
              ...
              guide: { title: 'Values-aligned capital', source: 'Alchemy §6 · Values-Aligned Capital',
                body: ['Money comes with expectations. An investor expecting 30% annual ROI will pressure you toward business over community. Screen for mission alignment, not just financial terms.',
      ...
      steps: [
        {
          ...
          fields: [
            { id: 'capital_committed', label: 'Capital committed so far', kind: 'input',
              ...
              guide: { title: 'Hard vs. soft capital', source: 'RNF Capital Formation',
                body: ['Hard: signed term sheets, deposits in escrow, board-approved grants. Soft: warm conversations, "I\'d love to support this." Track only the hard number publicly to your team.'] } },
            { id: 'capital_terms', label: 'Key capital terms', kind: 'textarea',
              help: 'Interest, equity, governance rights of capital sources.',
              guide: { title: 'Capital terms', source: 'Alchemy §6',
                body: ['For each source, document: amount · vehicle (debt/equity/grant) · interest or expected return · timeline · governance rights (board seats, veto, info) · exit terms.',
            ...
            { id: 'capital_risks', label: 'Capital risks', kind: 'textarea',
              ...
              guide: { title: 'Capital risk planning', source: 'RNF Economy',
            ...
            { id: 'investor_list', label: 'Investor & patron list', kind: 'textarea',
              ...
              guide: { title: 'Investor pipeline', source: 'Alchemy §2.4',
                body: ['Track every conversation: name · status (interested · in DD · committed · declined) · amount · last contact · next action.'] } },
          ],
          sliders: [
...

        {
          ...
          fields: [
            { id: 'mp_layout', label: 'Site layout principles', kind: 'textarea',
              ...
              guide: { title: 'Layout zoning', source: 'Alchemy §8 + permaculture zones',
                body: ['Permaculture zones (0–5) are a useful frame: 0 = home · 1 = daily-tended (kitchen garden) · 2 = weekly · 3 = annual production · 4 = managed forest · 5 = wild.',
                  'Layer in social zones: most-private dwellings · semi-private clusters · shared common buildings · public-facing visitor zones.'] } },
            { id: 'land_dev_pct', label: 'Land development split (%)', kind: 'input',
              help: 'Construction · food growth · conservation.',
              guide: { title: 'Development ratio', source: 'Workbook §8',
                body: ['Common splits in regenerative neighborhoods: 10–20% built · 20–40% productive (food, fiber, fuel) · 40–70% conservation/wild.'] } },
            { id: 'mp_phasing', label: 'Build phasing strategy', kind: 'textarea',
              help: 'What gets built first, second, third?',
              guide: { title: 'Build phasing', source: 'Alchemy §8',
                body: ['Typical phasing: 1) site infrastructure (water, road, power) 2) common house + 1–2 demonstration dwellings 3) phase-1 cluster of homes 4) productive infrastructure (gardens, barn) 5) further dwelling phases.',
            ...
            { id: 'mp_pillars', label: 'How does the master plan address each RNF pillar?', kind: 'textarea', rows: 6,
              ...
              guide: { title: 'Five-pillar check', source: 'RNF',
                body: ['A regenerative master plan answers all 5 pillars:',
            ...
            { id: 'building_methods', label: 'Building methods', kind: 'input',
              ...
              guide: { title: 'Building methods', source: 'Workbook §9',
                body: ['Options: Traditional construction (concrete/steel) · Bio construction (cob, straw bale, superadobe, hempcrete, bamboo) · Mass timber/CLT · Mixed approach.',
                  'Bio construction is highest-aligned with regen ethics but requires skilled crews and may face zoning resistance.'] } },
            { id: 'density_target', label: 'How many people per acre (or hectare) does your design assume?', kind: 'input',
              ...
              guide: { title: 'Population density', source: 'Alchemy §4 · Density Per Sq M',
                body: ['Low density (~0.5/acre) feels rural and spacious. High density (20+/acre) feels urban and vibrant.',
            ...
            { id: 'placemaking_character', label: 'What is the unique character and identity you want to create for this place?', kind: 'textarea',
              ...
              guide: { title: 'Placemaking & place character', source: 'Alchemy §4 · Placemaking',
                body: ['Every place has genius loci — spirit of place. Understand the land\'s history, local culture, and natural patterns. Design with them, not against them.',
...

        {
          ...
          checklist: [
            { id: 'c_water', text: 'Water systems designed and permitted',
              guide: { title: 'Water systems', source: 'Workbook §8 + RNF Ecology',
                body: ['Tick when you have engineered drawings + permits for: source(s), storage, treatment, distribution, AND wastewater (black + grey). Include backup plan when primary source fails.',
                  'Most regenerative projects aim for 2+ independent fresh-water sources. Verify yields across seasons.'] } },
            ...
            { id: 'c_connectivity', text: 'Connectivity infrastructure planned',
              guide: { title: 'Connectivity', source: 'Workbook §4',
                body: ['Tick when you have: primary internet (fiber/cable/Starlink), redundant backup, distribution (mesh Wi-Fi or wired), cellular coverage assessment.',
          ...
          fields: [
            { id: 'water_fresh', label: 'Fresh water system', kind: 'textarea',
              ...
              guide: { title: 'Fresh water', source: 'Workbook §8',
                body: ['Sources: well · spring · river · rainwater harvest · municipal · trucked. Most regenerative neighborhoods aim for 2+ independent sources. Treatment options: gravity filter, UV, ceramic, reverse osmosis.'] } },
            { id: 'energy_source', label: 'Energy source(s) & % self-produced', kind: 'textarea',
              help: 'Grid · solar · wind · micro-hydro · biogas · battery.',
              guide: { title: 'Energy strategy', source: 'Workbook §8',
                body: ['Regenerative neighborhoods typically aim for 60–100% on-site renewable production. Hybrid (grid + on-site solar) is the most resilient and economical for most climates.',
            ...
            { id: 'food_systems', label: 'Food systems implemented', kind: 'textarea',
              ...
              guide: { title: 'Food production', source: 'Workbook §8',
                body: ['Common systems: Agroforestry (food forest) · Annual gardens · Vertical gardens · Aquaponics · Hydroponics · Greenhouse · Livestock (chickens, goats, fish) · Wild harvest.',
                  'Most projects aim for 30–70% on-site food in year 3+.'] } },
            { id: 'amenities', label: 'Shared / social amenities planned', kind: 'textarea',
              ...
              guide: { title: 'Shared amenities', source: 'Workbook §4',
                body: ['Common picks: Community shared house · Shared kitchen-dining · Co-working · Ceremony / temple · Gym · Body of water (pool, lake, river, cenote, ocean) · School · Community garden · Art space · First-aid space · Makerspace.'] } },
            { id: 'build_timeline', label: 'Phased construction timeline', kind: 'textarea',
              help: 'What gets built in phase 1, 2, 3 — and by when?',
              guide: { title: 'Construction phasing', source: 'Community Alchemy Playbook — Area 9: Build Timeline',
                body: ['Build infrastructure BEFORE dwellings (water before walls), build shared spaces BEFORE private (common house before cottages), build revenue-generators BEFORE amenities.',
...

        {
          ...
          fields: [
            { id: 'rituals', label: 'Rituals & rhythms', kind: 'textarea',
              ...
              guide: { title: 'Rituals & rhythms', source: 'Alchemy §10',
                body: ['Daily: shared meals · morning circle · workday close.',
            ...
            { id: 'gatherings_internal', label: 'Internal gatherings', kind: 'textarea',
              ...
              guide: { title: 'Internal gatherings', source: 'Workbook §10',
            ...
            { id: 'events_external', label: 'Events open to visitors', kind: 'textarea',
              ...
              guide: { title: 'External events', source: 'Workbook §10',
            ...
            { id: 'onboarding', label: 'Member onboarding process', kind: 'textarea',
              ...
              guide: { title: 'Onboarding', source: 'Alchemy §2.7 — Onboarding',
                body: ['Common stages: pass screening · short visit · work trade · longer guest stay · community interview · written agreements · membership fee · community vote.',
            ...
            { id: 'screening', label: 'Screening process', kind: 'textarea',
              ...
              guide: { title: 'Screening', source: 'Alchemy §2.6 — Screening',
                body: ['A proper screening process: informational session · application · interview · reference checks · community feedback · trial period · agreements signed · community consensus on acceptance.'] } },
            { id: 'culture_carriers', label: 'Who carries the culture?', kind: 'textarea',
              help: 'Names, not roles.',
              guide: { title: 'Culture carriers', source: 'Alchemy §10 + RCOS Layer 2',
            ...
            { id: 'personal_regen_practices', label: 'Personal regeneration practices', kind: 'textarea',
              ...
              guide: { title: 'Personal regeneration', source: 'Community Alchemy Playbook — Area 10: Personal Regeneration',
                body: ['Alchemy recognizes that regenerating the land requires regenerated people. What practices support your members\' wellbeing?',
            ...
            { id: 'daily_rhythms', label: 'Daily & weekly rhythms', kind: 'textarea',
              ...
              guide: { title: 'Daily rhythms', source: 'Community Alchemy Playbook — Area 10: Rhythms & Rituals',
                body: ['Alchemy asks you to design the ordinary day with as much intention as the extraordinary ritual. Structure creates freedom — when people know what to expect, they can relax into community rather than negotiating everything.',
                  'Sketch: morning anchor · work blocks · rest/siesta · shared dinner nights · one community work day per week · one rest day.'] } },
          ],
          sliders: [
      ...
      steps: [
        {
          ...
          fields: [
            { id: 'ops_roles', label: 'Operational roles & rotation', kind: 'textarea',
              ...
              guide: { title: 'Operational roles', source: 'RCOS Layer 5 + Workbook',
                body: ['Document each operational role: name · responsibilities · time commitment · compensation · review cadence.',
                  'Rotation prevents burnout AND prevents single-point-of-knowledge failures. But over-rotation destroys mastery — find the right cadence per role.'] } },
            { id: 'ops_burnout', label: 'Burnout prevention practices', kind: 'textarea',
              help: 'How will you spot and address burnout early?',
              guide: { title: 'Burnout prevention', source: 'CLIPS Practice + RCOS',
                body: ['Practices: monthly check-in 1:1s · sabbatical policy · capped weekly hours per role · explicit "no" rights · paid time off for residents in roles.',
            ...
            { id: 'tools', label: 'Communication & management tooling', kind: 'textarea',
              ...
              guide: { title: 'Tooling', source: 'Workbook §11',
            ...
            { id: 'content_storytelling', label: 'Content & storytelling strategy', kind: 'textarea',
              ...
              guide: { title: 'Content & storytelling', source: 'Community Alchemy Playbook — Area 11: Storytelling',
                body: ['Alchemy emphasizes that how you tell your story IS part of your community design. Your narrative attracts members, investors, and allies who share your values.',
            ...
            { id: 'local_partnerships', label: 'Local partnerships being cultivated', kind: 'textarea',
              ...
              guide: { title: 'Local partnerships', source: 'Community Alchemy Playbook — Area 11: Local Integration',
                body: ['Strong local partnerships prevent insularity. Map: which local farms can you source from? Which local contractors will you hire? Which local government officials should know you by name?',
...

        {
          ...
          fields: [
            { id: 'gov_review', label: 'Governance review cadence', kind: 'textarea',
              ...
              guide: { title: 'Governance review', source: 'RCOS Layer 2',
                body: ['Healthy communities review governance annually at minimum, with smaller checkpoints quarterly. Review questions: what isn\'t working? · who\'s carrying too much? · what\'s out of date? · what new realities require new agreements?'] } },
            { id: 'gov_feedback', label: 'Feedback loops in place', kind: 'textarea',
              help: 'How does the community speak to itself?',
              guide: { title: 'Feedback loops', source: 'CLIPS Community',
            ...
            { id: 'activism', label: 'Activism & give-back programs', kind: 'textarea',
              ...
              guide: { title: 'Activism', source: 'Workbook §10',
            ...
            { id: 'web_marketing', label: 'Web & marketing presence', kind: 'textarea',
              ...
              guide: { title: 'Web presence', source: 'Workbook §7',
            ...
            { id: 'brand_identity', label: 'Brand & visual identity', kind: 'textarea',
              ...
              guide: { title: 'Brand identity', source: 'Community Alchemy Playbook — Area 7: Brand & Aesthetic',
                body: ['Alchemy treats aesthetics as culture made visible. Your brand is not decoration — it signals what kind of community you are and who belongs here.',
            ...
            { id: 'recruitment_funnel', label: 'Member recruitment funnel', kind: 'textarea',
              ...
              guide: { title: 'Recruitment funnel', source: 'Community Alchemy Playbook — Area 7: Member Attraction',
                body: ['Alchemy maps the prospective member journey: Awareness → Interest → Application → Visit → Decision.',
                  'Most intentional communities fill 80% of spots from personal referrals — design your referral process intentionally.'] } },
          ],
          sliders: [
...

        {
          ...
          fields: [
            { id: 'metrics', label: 'What you measure', kind: 'textarea',
              ...
              guide: { title: 'Measurement', source: 'RNF Measurement',
                body: ['Pick 1–3 metrics per RNF pillar:',
                  '· Ecology: biodiversity index · soil organic carbon · water cycle · food self-sufficiency %.',
            ...
            { id: 'learning_practices', label: 'Learning & adaptation practices', kind: 'textarea',
              ...
              guide: { title: 'Learning practices (RCOS Layer 6)', source: 'RCOS Layer 6',
            ...
            { id: 'next_horizon', label: 'Next horizon — what does the community want to become?', kind: 'textarea',
              ...
              guide: { title: 'Next horizon', source: 'Spiral Framework',
            ...
            { id: 'documentation_practice', label: 'Knowledge documentation & sharing practice', kind: 'textarea',
              ...
              guide: { title: 'Documentation practice', source: 'Community Alchemy Playbook — Area 12: Knowledge Commons',
                body: ['What gets documented: decisions and their rationale · experiments and outcomes · conflict resolutions and lessons · technical specs for infrastructure · role handovers.',
                  'The test: could a key person leave and the community carry on? If not, documentation is underdone.'] } },
            { id: 'external_contributions', label: 'Contributions to the wider regenerative movement', kind: 'textarea',
              ...
              guide: { title: 'External contributions', source: 'Community Alchemy Playbook — Area 12: Movement Building',
                body: ['Alchemy sees each intentional community as a node in a larger regenerative network. What unique learning can your community contribute?',
